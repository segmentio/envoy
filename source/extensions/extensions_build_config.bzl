...
WINDOWS_EXTENSIONS = {
    ...
    # These first three require opentracing to build on windows, but it is
    # a foreign_cc build based on a linux autotools build schema.
    # "envoy.tracers.dynamic_ot":                         "//source/extensions/tracers/dynamic_ot:config",
    # "envoy.tracers.lightstep":                          "//source/extensions/tracers/lightstep:config",
    # "envoy.tracers.datadog":                            "//source/extensions/tracers/datadog:config",
    "envoy.tracers.zipkin":                             "//source/extensions/tracers/zipkin:config",
    # The opencensus tool needs windows porting (unistd.h isn't c++)
    # "envoy.tracers.opencensus":                         "//source/extensions/tracers/opencensus:config",
    # WiP
    "envoy.tracers.xray":                               "//source/extensions/tracers/xray:config",
